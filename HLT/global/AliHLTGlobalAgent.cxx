					    ...
					    AliRunLoader* /*runloader*/) const
{
  ...
  TString esdInputs="TPC-globalmerger TPC-mcTrackMarker ITS-tracker TPC-HWCFDecoder TPC-ClusterTransformation GLOBAL-vertexer ITS-SPD-vertexer TPC-dEdx VZERO-RECO ITS-SAPtracker TRD-tracker"; // TRD-tracker added again for HLT TRD QA development, DISABLE GLOBAL VERTEXER TEMPORARILY
  //TString esdInputs="TPC-globalmerger TPC-mcTrackMarker ITS-tracker TPC-HWCFDecoder TPC-ClusterTransformation ITS-SPD-vertexer TPC-dEdx VZERO-RECO ITS-SAPtracker"; // TRD-tracker removed temporarily while it is still developed
